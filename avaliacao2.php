    ...
    <div class="content">
        ...
        <article class="artigo">
           <div class="session">
                ...
                <?php
                        $resposta2 = $_POST['caixa'];
                        setcookie("resposta2", $resposta2);
                    ?>
                    <h1>O que faz a tecla SHIFT?</h1>

                    <form method="POST" action="avaliacao3.php">
                        <div class="input">
                            <label for="caixa">
                                <input class="campos" type="radio" name="caixa" id="caixa" value="1" required>
                                Apagar caracteres a direita do cursor
                            </label>
                            </div>
                        ...
                        <div class="input">
                            <label for="caixas">
                                ...
                                Utilizar os segundos caracteres das teclas, ou intercalar entre as letras Maiúscula e Minúscula
                            </label>
                        </div>
