        ...
        <article class="artigo">
           <div class="session">
                <section class="sessao">
                    <h1>O que faz a tecla ENTER?</h1>

                    <form method="POST" action="avaliacao1.php">
                    <?php
                        setcookie("aluno1", "admin");
                    ?>
                        <div class="input">
                            <label for="caixa">
                                <input class="campos" type="radio" name="caixa" id="caixa" value="1" required>
                                Confirma e execução de um comando ou inicia a execução de um programa
                            </label>
                            </div>
                        ...
                        <div class="input">
                            <label for="caixas">
                                ...
                                Interrompe a execução de um comando ou programa
                            </label>
                        </div>

                        <div class="input">
                            <label for="caixao">
                                <input class="campos" type="radio" name="caixa" id="caixao" value="3" value= required>
                                Minimiza uma determinada janela
                            </label>
                        </div>
                        <br><br>
